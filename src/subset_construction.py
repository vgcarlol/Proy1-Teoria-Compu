...
def construct_afd(afn):
    ...
    # Verificar si el estado inicial del AFD es de aceptación
    ...
    while unmarked_states:
        ...
        for symbol in symbols:
            # Asegurarse de que se están procesando correctamente los movimientos y las clausuras epsilon
            ...
            # Si el nuevo conjunto de estados no está en el mapa, se añade
